                ...
                >
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{ paddingRight: "0px", height: "94.186px" }}
                    >
                      {/* Always show Summary */}
                      <div 
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          ...
                          // Auto fit columns after update
                          if (tableRef.current?.autoFitAllColumns) {
                            setTimeout(() => {
                              tableRef.current.autoFitAllColumns();
                            }, 300);
                          }
                          
                          toast.success("Đã cập nhật bảng dữ liệu!");
                        }}
                        className="w-[96px] h-[20px] mx-auto bg-primary hover:bg-primary/90 text-primary-foreground font-black uppercase tracking-wider text-[9px] rounded-lg transition-all cursor-pointer font-sans shadow-sm mt-1 flex items-center justify-center"
                        style={{ height: "20px" }}
                      >
                        UPDATE GRID
                      </button>
